...
const getAgentColor = (agentName) => {
  ...
  if (name.includes('SCANNER')) return '#8b5cf6';
  if (name.includes('BLUE')) return '#3b82f6';
  if (name.includes('RED')) return '#ef4444';
  if (name.includes('GATE') || name.includes('DEPLOY')) return '#10b981';
  return '#94a3b8';
};
                  ...
                  <tbody>
                    {[
                      ...
                      <tr key={i} style={{ borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
                        <td style={{ padding: '16px', fontFamily: 'Fira Code', color: '#38bdf8' }}>{row.id}</td>
                        ...
                        <td style={{ padding: '16px' }}>
                          <span style={{ padding: '4px 10px', borderRadius: '4px', fontSize: '0.7rem', fontWeight: 'bold', background: 'rgba(16, 185, 129, 0.15)', color: '#10b981', border: '1px solid rgba(16, 185, 129, 0.3)' }}>PATCHED VIA ADK</span>
                        </td>
                      </tr>
                    ))}
                  </tbody>
                ...
                {[
                  ...
                  <div key={policy.key} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '20px', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)', borderRadius: '8px' }}>
                    <div style={{ paddingRight: '20px' }}>
                      <span style={{ fontSize: '0.65rem', color: '#38bdf8', letterSpacing: '1px', fontWeight: 'bold' }}>{policy.group}</span>
